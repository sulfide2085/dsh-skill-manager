	...
	factory: (require) => {
		...
		function SkillsSection({ face, t }) {
			...
			react.useEffect(() => {
				...
				let alive = true;
				face.loadContent(expanded).then(
					(result) => {
						if (!alive) return;
