	...
	factory: (require) => {
		...
		function SkillsSection({ listSkills, loadContent, setSkillEnabled, setSourceEnabled, installZip, listRepos, addRepo, removeRepo, discoverRepo, installFromRepo, t }) {
			...
			return jsx("div", { className: c.section, children: [
				jsx(InstallPanel, { installZip, listRepos, addRepo, removeRepo, discoverRepo, installFromRepo, onInstalled: () => setRequest((n) => n + 1), t }),
		...
		function InstallPanel({ installZip, listRepos, addRepo, removeRepo, discoverRepo, installFromRepo, onInstalled, t }) {
